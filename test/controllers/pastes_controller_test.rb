...
class PastesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paste" do
    assert_difference("Paste.count") do
      post pastes_url, params: { paste: { access_id: @paste.access_id, paste: @paste.paste, title: @paste.title } }
    end
  ...
  test "should update paste" do
    patch paste_url(@paste), params: { paste: { access_id: @paste.access_id, paste: @paste.paste, title: @paste.title } }
